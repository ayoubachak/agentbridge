 ...
 * 
 * This server acts as the communication layer between AI agents and the React app.
...
wss.on('connection', (ws) => {
  ...
  const isAgent = !appClient; // First connection is assumed to be the app, others are agents
